    ...
    <div class="min-vh-100 d-flex align-items-center justify-content-center py-5">
        <?php foreach ($siswa as $row) : ?>
            <div class="card bg-body-secondary" style="width: 18rem;">
                <img src="<?php echo base_url('uploads/siswa/' . $row->foto_siswa); ?>" class="card-img-top responsive-img" alt="...">
                <div class="card-body">
                    <h3 class="card-text text-center"><?php echo $row->nama_siswa ?></h3>
                    <p class="text-secondary"><?php echo $row->alamat?></p>
                    <h4 class="text-center"><?php echo tampil_full_kelas_byid($row->id_kelas)?></h4>
