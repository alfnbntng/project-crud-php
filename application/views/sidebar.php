...
$active_page = ''; // Inisialisasi variabel halaman aktif
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <li class="sidebar-item <?php echo ($active_page == 'tabel') ? 'active' : ''; ?>">
                        ...
                        <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="<?php echo base_url('admin/siswa') ?>" class="sidebar-link">Siswa</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo base_url('admin/guru') ?>" class="sidebar-link">Guru</a>
                            </li>
                        </ul>
                    </li>
      ...
      <div class="main">
        ...
        <main class="content px-3 py-2">
          <div class="container-fluid">
            ...
            <!-- tag penutup saya letakan di setiap isi page yang ingin saya tampilkan bersamaan dengan sidebar  -->
